...
CREATE TABLE `cat_categorias` (
  ...
  `categoria` varchar(180) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `id_cat_tipo_contenido` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `cat_categorias` VALUES (2,'Live',2);
/*!40000 ALTER TABLE `cat_categorias` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cat_tipo_contenido`
--

DROP TABLE IF EXISTS `cat_tipo_contenido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cat_tipo_contenido` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_contenido` varchar(55) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `api` text NOT NULL,
...
--
-- Dumping data for table `cat_tipo_contenido`
--

LOCK TABLES `cat_tipo_contenido` WRITE;
/*!40000 ALTER TABLE `cat_tipo_contenido` DISABLE KEYS */;
INSERT INTO `cat_tipo_contenido` VALUES (2,'Live','live',0);
/*!40000 ALTER TABLE `cat_tipo_contenido` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `contenido` (
  ...
  `id_cat_categoria` varchar(255) DEFAULT NULL,
  `id_cat_tipo_contenido` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `usuario` (
  ...
  `contrasenia` varchar(105) DEFAULT NULL,
  `fecha_uconexion` datetime DEFAULT NULL,
  `ip_uconexion` varchar(35) DEFAULT NULL,
...
INSERT INTO `usuario` VALUES (27,'admin','31c11d8ee710d9f569d03b0f39ee871c0599bb752254ff4cc4873a35f07fe244','2018-06-07 17:41:49','127.0.0.1','2018-04-26 01:25:29',1,NULL,NULL,'0');
...
-- Dump completed on 2018-06-07 17:01:18
