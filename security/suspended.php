...
<body>
<div id="content">
    <h1 class="headline">403 Error - Cuenta suspendida.</h1>
    <p>Una excepci&oacute;n con error 403 se ha producido, la petici&oacute;n sera terminada.</p>

    <ul>
        <li>Su usuario ha sido suspendido por el sistema.</li>
        <li>Su usuario ha sido suspendido por su proveedor.</li>
        <li>El sistema expl&iacute;citamente bloquea su acceso.</li>
